...
; endfun
    ;
; Function on main.ts:162
    ;
    .section code
    .balign 4
    .section code
DightalTubes_on__P867:
DightalTubes_on__P867_nochk:
    @stackmark func
    @stackmark args
    push {lr}
.locals:
    @stackmark locals
DightalTubes_on__P867_locals:
    ldr r7, [r6, #0]
    ldr r0, [r7, #36]
    push {r0} ; proc-arg
    movs r1, #33
...
.ret.867:
    ...
    movs r0, #0
.final_0_3:
DightalTubes_on__P867_end:
    pop {pc}
    @stackempty func
    @stackempty args
; endfun
    ;
; Function cmd main.ts:143
    ;
    .section code
    .balign 4
    .section code
DightalTubes_cmd__P865:
DightalTubes_cmd__P865_nochk:
    @stackmark func
    @stackmark args
    push {lr}
.locals:
    @stackmark locals
DightalTubes_cmd__P865_locals:
    ldr r0, [sp, args@0]
    push {r0} ; proc-arg
    ldr r7, [r6, #0]
    ldr r0, [r7, #40]
    push {r0} ; proc-arg
    bl DightalTubes_writeByte__P864
_proccall4:
    add sp, #4*2 ; pop locals 2
    @stackempty locals
.ret.865:
    ...
    movs r0, #0
.final_0_4:
DightalTubes_cmd__P865_end:
    pop {pc}
    @stackempty func
    @stackempty args
; endfun
    ;
; Function writeByte main.ts:96
    ;
    .section code
    .balign 4
    .section code
DightalTubes_writeByte__P864:
DightalTubes_writeByte__P864_nochk:
    @stackmark func
    @stackmark args
    push {lr}
.locals:
    ...
    push {r0} ;loc
    @stackmark locals
DightalTubes_writeByte__P864_locals:
    movs r0, #1
    str r0, [sp, locals@0]
    @stackempty locals
    movs r0, #1
    ...
    str r0, [sp, locals@0]
    @stackempty locals
    bl DightalTubes_FrameStart_1650__P861
_proccall5:
    @stackempty locals
    movs r0, #1
    str r0, [sp, locals@1]
...
.cont.893:
    ...
    b .fortop.893      
.brk.893:
    bl DightalTubes_FrameAck_1650__P863
_proccall9:
    movs r1, #3
    bl _cmp_eq
    beq .else_2_5      
...
.else_6_5:
.afterif_7_5:
    bl DightalTubes_FrameEnd_1650__P862
_proccall14:
    @stackempty locals
    ldr r0, [sp, locals@2]
.ret.864:
...
DightalTubes_writeByte__P864_end:
    pop {pc}
    @stackempty func
    @stackempty args
; endfun
    ;
; Function FrameEnd_1650 main.ts:76
    ;
    .section code
    .balign 4
    .section code
DightalTubes_FrameEnd_1650__P862:
DightalTubes_FrameEnd_1650__P862_nochk:
    @stackmark func
    @stackmark args
    push {lr}
.locals:
    @stackmark locals
DightalTubes_FrameEnd_1650__P862_locals:
    ldr r7, [r6, #0]
    ldr r0, [r7, #44]
    push {r0} ; proc-arg
    bl _conv_2
...
.ret.862:
    ...
    movs r0, #0
.final_0_6:
DightalTubes_FrameEnd_1650__P862_end:
    pop {pc}
    @stackempty func
    @stackempty args
; endfun
    ;
; Function FrameAck_1650 main.ts:84
    ;
    .section code
    .balign 4
    .section code
DightalTubes_FrameAck_1650__P863:
DightalTubes_FrameAck_1650__P863_nochk:
    @stackmark func
    @stackmark args
    push {lr}
.locals:
    @stackmark locals
DightalTubes_FrameAck_1650__P863_locals:
    ldr r7, [r6, #0]
    ldr r0, [r7, #44]
    push {r0} ; proc-arg
    bl _conv_2
...
.ret.863:
    @stackempty locals
.final_2_7:
DightalTubes_FrameAck_1650__P863_end:
    pop {pc}
    @stackempty func
    @stackempty args
; endfun
    ;
; Function FrameStart_1650 main.ts:68
    ;
    .section code
    .balign 4
    .section code
DightalTubes_FrameStart_1650__P861:
DightalTubes_FrameStart_1650__P861_nochk:
    @stackmark func
    @stackmark args
    push {lr}
.locals:
    @stackmark locals
DightalTubes_FrameStart_1650__P861_locals:
    ldr r7, [r6, #0]
    ldr r0, [r7, #44]
    push {r0} ; proc-arg
    bl _conv_2
...
.ret.861:
    ...
    movs r0, #0
.final_0_8:
DightalTubes_FrameStart_1650__P861_end:
    pop {pc}
    @stackempty func
    @stackempty args
; endfun
    ;
; Function showNumber main.ts:208
    ;
    .section code
    .balign 4
    .section code
...
; endfun
    ;
; Function digit main.ts:197
    ;
    .section code
    .balign 4
    .section code
DightalTubes_digit__P870:
DightalTubes_digit__P870_nochk:
    @stackmark func
    @stackmark args
    push {lr}
.locals:
    @stackmark locals
DightalTubes_digit__P870_locals:
    ldr r7, [r6, #0]
    ldr r0, [r7, #52]
    push {r0} ; proc-arg
    ldr r0, [sp, args@1]
...
.ret.870:
    ...
    movs r0, #0
.final_0_10:
DightalTubes_digit__P870_end:
    pop {pc}
    @stackempty func
    @stackempty args
; endfun
    ;
; Function dat main.ts:152
    ;
    .section code
    .balign 4
    .section code
DightalTubes_dat__P866:
DightalTubes_dat__P866_nochk:
    @stackmark func
    @stackmark args
    push {lr}
.locals:
    @stackmark locals
DightalTubes_dat__P866_locals:
    ldr r7, [r6, #0]
    ldr r0, [r7, #16]
    push {r0} ; proc-arg
    ldr r0, [sp, args@0]
